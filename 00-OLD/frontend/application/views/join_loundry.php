...
<head>
    ...
    <title>GO3JEK - Registration</title>
...
<div class="wrapper">
    ...
    <div id="main" class="container mt-5 pt-5">
        <div class="row justify-content-center mb-3 border-bottom">
            <h1 class="display-4 font-weight-bold">Registrasi GO3Loundry</h1>
        </div>
        <div class="row">
            <div class="col-md-4 d-none d-sm-block">
                <div class="reg-image-ride"></div>
                <div class="card mt-2">
                    <div class="card-body">
                        <dl>
                    ...
                    <fieldset class="form-group column flex-wrap">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="foto_ktp" id="foto_ktp" accept="image/*" class="form-control" style="">
                            </div>
                            <div class="form-group">
                                <label for="foto_stnk" class="font-weight-bold">Foto STNK</label>
                                <input type="file" name="foto_stnk" id="foto_stnk" accept="image/*" class="form-control" style="">
                            </div>
                            <div class="form-group">
                                <label for="foto_sim" class="font-weight-bold">Foto SIM</label>
                                <input type="file" name="foto_sim" id="foto_sim" accept="image/*" class="form-control" style="">
                            </div>
                            <div class="form-group">
                                <label for="foto_diri" class="font-weight-bold">Foto Diri</label>
                                <input type="file" name="foto_diri" id="foto_diri" accept="image/*" class="form-control" style="">
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form-group column flex-wrap">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="merk" id="merk" class="form-control" placeholder="ex: Honda, Toyota">
                            </div>
                            <div class="form-group">
                                <label for="tipe" class="font-weight-bold">Tipe Kendaraan</label>
                                <input type="text" name="tipe" id="tipe" class="form-control" placeholder="ex: Sport, Matic">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                                <label for="nomor_kendaraan" class="font-weight-bold">Plat Nomor Kendaraan</label>
                                <input type="text" name="nomor_kendaraan" id="nomor_kendaraan" class="form-control" placeholder="ex: BG660EG">
                            </div>
                            <div class="form-group">
                                <label for="warna" class="font-weight-bold">Warna Kendaraan</label>
                                <input type="text" name="warna" id="warna" class="form-control" placeholder="ex: Merah, Biru">
                            </div>
                        </div>
                    </fieldset>
